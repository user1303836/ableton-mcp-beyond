...
const FAMILIES = [
  ...
  { family: "song-link", surface: "Song state, settings, Link, time conversion", operations: ["song.read", "song.set", "song.time-convert"], firstTested: "pending exact candidate" },
  { family: "track-structure", surface: "Return tracks, duplication, Track.View, track properties", operations: ["track.create-return", "track.delete-return", "track.duplicate", "scene.duplicate", "track.view.set", "track.select-instrument", "track.set"], firstTested: "pending exact candidate" },
