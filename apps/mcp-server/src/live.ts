...
function createSimulatorState(): LiveSnapshot {
  ...
  return {
    ...
    song: { visibleTracks: [ref("track", "track-1")], appointedDevice: ref("device", "utility-1"), songLength: 64, startTime: 0, signatureNumerator: 4, signatureDenominator: 4, swingAmount: 0, overdub: false, arrangementOverdub: false, backToArranger: false, canCaptureMidi: true, canUndo: true, canRedo: false, exclusiveArm: true, exclusiveSolo: true, isCountingIn: false, tempoFollowerEnabled: false, reEnableAutomationEnabled: false, sessionRecord: false, sessionAutomationRecord: false, clipTriggerQuantization: { name: "grid_sixteenth", value: 5 }, midiRecordingQuantization: { name: "rec_quantisation_off", value: 0 }, isAbletonLinkEnabled: true, isAbletonLinkStartStopSyncEnabled: false, tempoFollower: false },
