...
export class McpHost {
  ...
  private async liveRecoveryFinalizeAsync(id: RequestId, params: unknown): Promise<JsonObject> {
    ...
    try {
      ...
      if (!owner && !midiFinalizable && !batchFinalizable) return this.recoveryFinalizeError(id, "Recovery transaction was not found or is not finalizable.");
