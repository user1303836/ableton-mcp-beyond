...
No implemented workflow inserts or deletes devices, loads browser results, edits racks/chains, changes routing, starts recording, controls plug-in UI, captures Live audio, or provides realtime performance authority.
